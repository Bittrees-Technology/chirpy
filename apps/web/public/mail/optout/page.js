...
const words={
  en:{title:'Chirpy email preferences',heading:'Stop Chirpy email',explanation:'Confirm to stop future Chirpy email to this address from all wallets. This does not recall email already sent or change your wallet chats.',button:'Stop future email',privacy:'No wallet connection or sign-in is required. Anyone with this private link can stop email to its recipient.',ready:'Opening this page has not changed your preference.',invalid:'This link is missing or no longer available. Reopen the complete link from your email.',pending:'Confirming your preference…',success:'Future Chirpy email to this address is stopped. Messages already handed off may still arrive.',error:'The change could not be confirmed. Please try again.',limited:'Please wait a moment, then try again.'},
  es:{title:'Preferencias de correo de Chirpy',heading:'Dejar de recibir correos de Chirpy',explanation:'Confirma para dejar de recibir correos de Chirpy de cualquier billetera en esta dirección. Esto no retira correos ya enviados ni cambia tus chats de billetera.',button:'Dejar de recibir correos',privacy:'No necesitas conectar una billetera ni iniciar sesión. Cualquier persona con este enlace privado puede detener los correos a su destinatario.',ready:'Abrir esta página no ha cambiado tu preferencia.',invalid:'Este enlace falta o ya no está disponible. Vuelve a abrir el enlace completo de tu correo.',pending:'Confirmando tu preferencia…',success:'Se han detenido los futuros correos de Chirpy a esta dirección. Los mensajes ya entregados al proveedor aún pueden llegar.',error:'No se pudo confirmar el cambio. Inténtalo de nuevo.',limited:'Espera un momento e inténtalo de nuevo.'}
};
