...
export function Mailbox({onOpenSettings}:{onOpenSettings:()=>void}){
 ...
 const clearPrivate=()=>{setDraft(emptyDraft());setComposing(false);setHtmlPreview(null);setAttachments(null);setThreads([]);setConversation(null);setMessages([]);setMessage(null);setFolders([]);setCursors([]);setNextCursor(null);};
