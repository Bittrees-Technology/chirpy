...
Outstanding production acceptance includes gate hosting/identity/registry, real chain admission, operator backups/alerts/moderation, public privacy/terms, native signing/devices and remaining dependency applicability review. Large inbox performance, shared UI/integrations and final artwork remain product work. Expanded XMTP nightly failures now fail the workflow; they are not advisory.
