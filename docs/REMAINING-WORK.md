...
5. **Native distribution:** supply release/signing credentials and repository variables; verify signed/notarized macOS and Windows signing, downloaded artifact signatures, clean install and updater behavior. Complete iOS real-device storage/wallet-return/deep-link and TestFlight acceptance. Prepared artifacts remain drafts.
